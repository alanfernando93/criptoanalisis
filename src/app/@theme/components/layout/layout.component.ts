...
import {
   ...
   */
  @Component({
    selector: 'ngx-layout-column',
    template: `
      <ng-content></ng-content>
    `,
  })
  export class NgxLayoutColumnComponent {
  ...
  export class NgxLayoutFooterComponent {
  ...
  @Component({
    ...
    template: `
      ...
      <div class="scrollable-container" #scrollableContainer>
        <div class="layout">
          <ng-content select="ngx-layout-header"></ng-content>
          <div class="layout-container">
            <ng-content select="nb-sidebar"></ng-content>
            <div class="content" [class.center]="centerValue">
              <div class="columns">
                <ng-content select="ngx-layout-column"></ng-content>
              </div>
              <ng-content select="ngx-layout-footer"></ng-content>
            </div>
          </div>
        </div>
      </div>
  ...
  export class NgxLayoutComponent implements AfterViewInit, OnInit, OnDestroy {
